...
public class AppInsightsActivityy extends AppCompatActivity {
    private static final UsageUtill usageUtil = new UsageUtill();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_insightss);
