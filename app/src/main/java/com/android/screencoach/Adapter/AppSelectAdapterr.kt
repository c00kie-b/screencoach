...
class AppSelectAdapterr(private var appList: List<AppSelectModell>) :
    RecyclerView.Adapter<AppSelectAdapterr.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.list_app_selectt, parent, false)
    ...
    fun updateListSelect(newList: List<AppSelectModell>) {
        appList = newList
