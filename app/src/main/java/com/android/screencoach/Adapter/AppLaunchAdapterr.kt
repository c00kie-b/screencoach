...
class AppLaunchAdapterr(private var appList: List<AppUsageModel>) :
    RecyclerView.Adapter<AppLaunchAdapterr.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.list_app_usagee, parent, false)
