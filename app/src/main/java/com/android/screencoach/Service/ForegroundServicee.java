...
import com.android.achievix.Activity.DrawOnTopScreenActivityy;
import com.android.achievix.Activity.EnterPasswordActivityy;
import com.android.achievix.Activity.MainActivityy;
import com.android.achievix.Database.AppLaunchDatabasee;
import com.android.achievix.Database.BlockDatabasee;
import com.android.achievix.Utility.NetworkUtill;
...
public class ForegroundServicee extends Service {
    private static final String CHANNEL_ID = "ForegroundServiceChannel";
    private static String currentApp = "";
    private final AppLaunchDatabasee appLaunchDatabase;
    private final BlockDatabasee blockDatabase;
    ...
    public ForegroundServicee() {
        appLaunchDatabase = new AppLaunchDatabasee(this);
        blockDatabase = new BlockDatabasee(this);
    }
    ...
    private void startForegroundService() {
        ...
        Intent notificationIntent = i != 0 ? new Intent(this, EnterPasswordActivityy.class) : new Intent(this, MainActivityy.class);
        notificationIntent.putExtra("password", i);
        notificationIntent.putExtra("invokedFrom", "ForegroundServicee");

        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, FLAG_IMMUTABLE);
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("ScreenCoach")
            ...
            for (HashMap<String, String> map : filteredList) {
                if(Objects.equals(map.get("packageName"), currentApp)) {
                    if (Objects.equals(map.get("scheduleType"), "Usage Time") && Objects.equals(map.get("profileStatus"), "1")) {
                        ...
                        if (Objects.equals(map.get("launch"), "1")) {
                            ...
                            if (usageStats != null) {
                                ...
                                if (timeInMinutes >= (hour * 60L + minute)) {
                                    ...
                                    Intent lockIntent = new Intent(mContext, DrawOnTopLaunchActivityy.class);
                        ...
                        float total = new NetworkUtill().getPackageInfo(0, System.currentTimeMillis(), currentApp, mobile, wifi, mContext);
                        if (total >= usage) {
                            timer.cancel();
                            System.gc();
                            Runtime.getRuntime().runFinalization();
    ...
    public void takeBreak(CountDownTimer timer) {
        ...
        if(!sh.getBoolean("call", false)){
            if(sh.getInt("hour", 0) >= Calendar.getInstance().get(Calendar.HOUR_OF_DAY) &&
                ...
                timer.cancel();
                Intent lockIntent = new Intent(mContext, DrawOnTopScreenActivityy.class);
                lockIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                lockIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                lockIntent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
